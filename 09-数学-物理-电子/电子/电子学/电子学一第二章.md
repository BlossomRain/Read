...
| 共模拾取 | **$R_3=R_2=24.9\,\mathrm{k}\Omega$** 串联于两输入端，中点 **$V_{o\_cm}$** | 估计 $\dfrac{v_1+v_2}{2}\approx v_{cm}$ |
| 右脚驱动 | **AD705J** 反相放大；$v_+$ 接地；**$R_4=1\,\mathrm{M}\Omega$** 反馈；**$R_1=10\,\mathrm{k}\Omega$** 与 **$C_1$** 串联支路与 $R_4$ 并联；输出 **$V_{f\_cm}$** → 右脚 | 反相共模回馈（$R_4$ 限制注入电流） |
...
|------------------|---------------------|
| $R_1$ 中点 $\approx v_{cm}$ | $R_2,R_3$ 中点 $V_{o\_cm}$ |
| 反相 + 大电阻 → 右脚 | AD705 + $R_4=1\,\mathrm{M}\Omega$ → $V_{f\_cm}$ |
